Public Class productos_terminados_form
    ...
    Private Sub Productos_TerminadosBindingNavigatorSaveItem_Click_3(sender As Object, e As EventArgs)
        Me.Validate()
        Me.Productos_TerminadosBindingSource.EndEdit()
        Me.TableAdapterManager.UpdateAll(Me.Delis_CakeDataSet)
    ...
    Private Sub Productos_TerminadosBindingNavigatorSaveItem_Click_4(sender As Object, e As EventArgs) Handles Productos_TerminadosBindingNavigatorSaveItem.Click
        Me.Validate()
        Me.Productos_TerminadosBindingSource.EndEdit()
        Me.TableAdapterManager.UpdateAll(Me.Delis_CakeDataSet)
